...
f1_comment_1 = Comment(u"test 123 hallo bla bla", startl=0, endl=4)
f1_comment_2 = Comment(u"aaaaaaaaaa wdew qdwq dwqd wqd frtg ftghf th fth gzhvgz h fh", startl=18, endl=25)
file_1.add_comment(f1_comment_1)
file_1.add_comment(f1_comment_2)

f2_comment_1 = Comment(u"bla blablab blabla blablab blabla blablab blabla blablab bla", startl=54, endl=64)
f2_comment_2 = Comment(u"aaaaa bbbb cccc ddd eee fff ggg", startl=264, endl=268)
file_2.add_comment(f2_comment_1)
file_2.add_comment(f2_comment_2)

f1_c1_marker_1 = Marker(0, 3, 12)
f1_c1_marker_2 = Marker(2, 0, 5)
f1_comment_1.add_marker(f1_c1_marker_1)
f1_comment_1.add_marker(f1_c1_marker_2)

f1_c2_marker_1 = Marker(21, 3, 20)
f1_comment_2.add_marker(f1_c2_marker_1)

f2_c1_marker_1 = Marker(58, 10, 30)
f2_comment_1.add_marker(f2_c1_marker_1)

f2_c2_marker_1 = Marker(268, 0, 10)
